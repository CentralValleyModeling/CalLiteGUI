...
/*
 * SummaryTablePanel2.java - holder for first-cut summary table code
 *
 */
...
public class SummaryTablePanel2 extends JPanel {
        int n[][];
        double x[][];
        double xx[][];
        double avg[][];
        ...
        SummaryTablePanel2(TimeSeriesContainer tscs[], String tagString) {
