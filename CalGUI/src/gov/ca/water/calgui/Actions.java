...
public class Actions {
	...
	public static void UD_Table(ActionEvent e) {
	...
	public static void AC_Save(ActionEvent e, JFrame desktop, SwingEngine swix, Boolean[] RegUserEdits,
	        DataFileTableModel[] dTableModels, GUILinks gl) {
	...
	public static void AC_LoadScen(ActionEvent e, JFrame desktop, SwingEngine swix, Boolean[] RegUserEdits,
	        DataFileTableModel[] dTableModels, GUILinks gl, int action_WSIDI) {
	...
	public static void AC_CompScen(ActionEvent e, JFrame desktop, SwingEngine swix, Boolean[] RegUserEdits,
	        DataFileTableModel[] dTableModels, GUILinks gl) {
	...
	public static void AC_ViewScen(ActionEvent e, JFrame desktop, SwingEngine swix, Boolean[] RegUserEdits,
	        DataFileTableModel[] dTableModels, GUILinks gl) {
	...
	public static void Reg_Copy(SwingEngine swix) {
	...
	public static void Reg_Paste(SwingEngine swix) {
	...
	public static void Reg_Default(SwingEngine swix, Boolean[] RegUserEdits) {
	...
	public static void Op_TableEdit(ActionEvent e, SwingEngine swix) {
		...
		// DKRpopulateDTable(cName, table, component);
	...
	public static void Op_Copy(SwingEngine swix) {
	...
	public static void Op_Paste(SwingEngine swix) {
	...
	public static void HYD_Clear(SwingEngine swix) {
	...
	public static void HYD_All(SwingEngine swix) {
	...
	public static void HYD_B1(SwingEngine swix) {
	...
	public static void HYD_A2(SwingEngine swix) {
		 ...
		 * btnFile0.addActionListener((ActionListener) getDSSFilename0); GetDSSFilename getDSSFilename1 = new GetDSSFilename(null,
		 * (JTextField) swix2.find("tfReportFILE1")); JButton btnFile1 = (JButton) swix2.find("btnGetReportFile1");
		 * btnFile1.addActionListener((ActionListener) getDSSFilename1); GetDSSFilename getDSSFilename2 = new GetDSSFilename(null,
		 * (JTextField) swix2.find("tfReportFILE2")); JButton btnFile2 = (JButton) swix2.find("btnGetReportFile2");
		 * btnFile2.addActionListener((ActionListener) getDSSFilename2); GetDSSFilename getDSSFilename3 = new GetDSSFilename(null,
		 * (JTextField) swix2.find("tfReportFILE3"), "PDF"); JButton btnFile3 = (JButton) swix2.find("btnGetReportFile3");
		 * btnFile3.addActionListener((ActionListener) getDSSFilename3); } catch (Exception e1) { // TODO Auto-generated catch block
		 * e1.printStackTrace(); }
		 */
