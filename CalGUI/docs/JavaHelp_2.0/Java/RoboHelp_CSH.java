...
*****************************************************************************************
	...
	RH_ShowMultiscreenHelpWithMapNo
		Syntax:
			public static boolean RH_ShowMultiscreenHelpWithMapNo(int hParent, String a_pszHelpFile, String a_pszWindow, long dwMapNo)
		...
		a_pszHelpFile
			Path to help system start page ("http://www.myurl.com/help/help.htm" or "file:///C:/Program Files/MyApp/help/help.htm")
			Local path to be specified only in the format specified above as an example.
		...
		Examples:
			   RoboHelp_CSH.RH_ShowMultiscreenHelpWithMapNo(0, "http://www.myurl.com/help/help.htm", "", 10); 
			   RoboHelp_CSH.RH_ShowHelp(0, "file:///C:/Program Files/MyApp/help/help.htm", "MultiScreenWindow", 100); 
			   
	-----------------------------------------------------------------------------------
			   
	RH_ShowMultiscreenHelpWithMapId
		Syntax:
			public static boolean RH_ShowMultiscreenHelpWithMapId(int hParent, String a_pszHelpFile, String a_pszWindow, String a_pszMapId)
		...
		Examples:
			   RoboHelp_CSH.RH_ShowMultiscreenHelpWithMapNo(0, "http://www.myurl.com/help/help.htm", "", "HelpTopic"); 
			   RoboHelp_CSH.RH_ShowHelp(0, "file:///C:/Program Files/MyApp/help/help.htm", "MultiScreenWindow", "HelpTopic"); 		
...
public class RoboHelp_CSH
{
	...
	public static final int HH_HELP_CONTEXT = 15;        
        ...
        public static boolean RH_ShowHelpForContext(int hParent/* reserved */, String a_pszHelpFile, 
													String a_pszContext, int uCommand, int dwData)
        {
			...
			return RH_ShowHelp(hParent, strHelpPath, uCommand, dwData);
        }
	...
	public static boolean RH_ShowMultiscreenHelpWithMapNo(int hParent, String a_pszHelpFile, String a_pszWindow, long dwMapNo)
	{
		String strParam = "?rhcsh=1";
		if (a_pszHelpFile == "")
			return false;
		
		if(a_pszWindow != "")
			strParam += "&rhwnd=" + a_pszWindow;
		if(dwMapNo > 0)
			strParam += "&rhmapno=" + String.valueOf(dwMapNo);
		String strURL = a_pszHelpFile + strParam;
...
//	System.out.println("4strOut is now '" + strOut + "'");
	...
	public static boolean RH_Show_BrowserBasedHelp(int hParent/* reserved */, String strHelpPath, 
													String strContext, String strWnd,int uCommand, int nMapId)
	{
		String strHelpFile = "";
		if (strHelpPath != null)
		{
			...
			if (isValidString(strHelpFile))
			{
				...
				if(isValidString(strContext))
				{
					strHelpFile += ">>helpid=" + strContext;
				}
				strHelpFile += ">>newwnd=false";
				return ShowHelpURL(strHelpFile);
			}
										...
										String a_pszTopicURL)
	{
		...
		{
			strCommandLine += " -csh" ;
			if( isValidString(a_pszHelpId))
			{
				strCommandLine += " helpid \"" + a_pszHelpId + "\"" ; 
			}
			
			if(isValidString(a_pszWindowName))
			{
				strCommandLine += " window \"" + a_pszWindowName + "\"" ; 
			}
			
			if(isValidString(a_pszTopicURL))
			{
				strCommandLine += " topicurl \"" + a_pszTopicURL + "\"" ; 
			}
			
			else if(isValidString(a_pszMapId))
			{
	...
	private static boolean isValidString(String a_pszString) {
		return a_pszString!=null && !a_pszString.isEmpty();
	}
}
