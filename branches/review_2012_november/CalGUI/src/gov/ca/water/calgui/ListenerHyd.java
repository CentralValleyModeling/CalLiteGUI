...
public class ListenerHyd implements ItemListener {
	...
	public ListenerHyd(JFrame desktop, SwingEngine swix, Boolean[] RegUserEdits, DataFileTableModel[] dTableModels, GUILinks gl,
	        int action_WSIDI) {
