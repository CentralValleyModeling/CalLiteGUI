...
public class DSSGrabber {
	...
	public void calcTAFforCFS(TimeSeriesContainer[] primaryResults, TimeSeriesContainer[] secondaryResults) {
		...
		/*
		 * Procedure calculates annual volume in TAF for any CFS dataset, and replaces monthly values if TAF flag is checked.
		 * 
	...
	public TimeSeriesContainer[][] getExceedanceSeries(TimeSeriesContainer[] timeSeriesResults) {
		...
		/*
		 * Generates exceedance time series for all values [index=0], for each month's values [1..12], and [TBI] for annual totals
		 * [Index=13]
		 */
