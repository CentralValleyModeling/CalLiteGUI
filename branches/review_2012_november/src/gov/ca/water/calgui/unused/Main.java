...
public class Main {
	...
	public static void main(String[] args) {
		...
		final InputFilePanel inputFilePanel = new InputFilePanel("Template Input File");
				...
				SwingUtilities.invokeLater(new Runnable() {
					...
					public void run() {
						try {
							...
							Runtime.getRuntime().exec("cmd /c start " + ofile.getAbsolutePath());
						} catch (Exception ex) {
							JOptionPane.showMessageDialog(runButton, ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
						} finally {
	...
	/**
	 * Creates a panel consisting of label, a textfield populated by a browse (file browser) button
	 * 
	 * @return
	 */
		...
		public InputFilePanel(String label) {
			...
			browseButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					int showOpenDialog = fileChooser.showOpenDialog(InputFilePanel.this);
