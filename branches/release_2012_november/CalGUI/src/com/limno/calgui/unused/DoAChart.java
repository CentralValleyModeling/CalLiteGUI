...
public class DoAChart {
	...
	public void main(TimeSeriesContainer tsc) {
		...
		org.jfree.data.time.TimeSeries s1 = new org.jfree.data.time.TimeSeries(
				"Trinity Storage");
		org.jfree.data.time.TimeSeries s2 = new org.jfree.data.time.TimeSeries(
				"Trinity Storage Exceedance");
